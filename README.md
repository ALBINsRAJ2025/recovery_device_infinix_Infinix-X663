# Infinix Note 11 X663 TWRP Device Tree

Custom TWRP (Team Win Recovery Project) for Infinix Note 11 X663 (X663).
...
3. **Flash TWRP boot image**
   - Select Install
   - Choose TWRP.img flash to boot or recovery ramdisk
   - Swipe to confirm
   - Wait for completion

4. **Reboot to recovery**
   - Select Reboot → Recovery
   - Device reboots into TWRP



✅ **TWRP is ready for use!**

---

## Decryption

TWRP supports full decryption:
